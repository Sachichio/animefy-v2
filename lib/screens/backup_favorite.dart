...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  Future<void> loadFavorites() async {
    setState(() {
      isLoading = true;
      _loadedIndexes.clear(); // 🔥 Reset animasi gambar saat reload
    });
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => DetailScreen(anime: anime, userId: userId)),
                        );
                        await loadFavorites(); // Reload setelah kembali
                      },
                    );
                  },
                ),
